...
const (
	...
	Master_GetNeighborsStatus_FullMethodName = "/protocol.Master/GetNeighborsStatus"
)
...
type MasterClient interface {
	...
	GetNeighborsStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*NeighborsStatus, error)
}
...
func (c *masterClient) GetNeighborsStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*NeighborsStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NeighborsStatus)
	err := c.cc.Invoke(ctx, Master_GetNeighborsStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterServer interface {
	...
	// check neighbors status
	GetNeighborsStatus(context.Context, *Empty) (*NeighborsStatus, error)
...
func (UnimplementedMasterServer) GetNeighborsStatus(context.Context, *Empty) (*NeighborsStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNeighborsStatus not implemented")
}
...
func _Master_GetNeighborsStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServer).GetNeighborsStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Master_GetNeighborsStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServer).GetNeighborsStatus(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Master_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNeighborsStatus",
			Handler:    _Master_GetNeighborsStatus_Handler,
		},
	},
